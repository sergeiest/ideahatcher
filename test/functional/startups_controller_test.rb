...
class StartupsControllerTest < ActionController::TestCase
  ...
  test "should create startup" do
    assert_difference('Startup.count') do
      post :create, startup: { content: @startup.content, name: @startup.name, title: @startup.title, image_path: @startup.image_path }
    end
  ...
  test "should update startup" do
    put :update, id: @startup, startup: { content: @startup.content, name: @startup.name, title: @startup.title, image_path: startup.image_path  }
    assert_redirected_to startup_path(assigns(:startup))
  end
