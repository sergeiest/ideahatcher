...
class AuthenticationsControllerTest < ActionController::TestCase
  ...
  test "should create authentication" do
    assert_difference('Authentication.count') do
      post :create, authentication: { password: @authentication.password, status: @authentication.status, username: @authentication.username }
    end
  ...
  test "should update authentication" do
    put :update, id: @authentication, authentication: { password: @authentication.password, status: @authentication.status, username: @authentication.username }
    assert_redirected_to authentication_path(assigns(:authentication))
  end
